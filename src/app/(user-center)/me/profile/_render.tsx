...
import { Anchor, Box, Breadcrumbs, Divider, FocusTrap, Grid, Group, LoadingOverlay, Paper, Radio, RadioGroup, Stack, Text, Textarea, TextInput, Title } from '@mantine/core';
...
const ProfilePageRender = ({initialData}:ProfilePageProps) => {
